...
- (void)setup {
    ...
    for (int i = 0; i < 9; i++) {
        ...
        [btn setImage:[UIImage imageNamed:@"gesture"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"selective gestures"] forState:UIControlStateSelected];
        btn.tag = 1000+i;
        [self addSubview:btn];
    }
}
